<?php
// $Id: view.php,v 1.22 2010/02/07 09:33:33 fabiangebert Exp $
/**
 * This page prints a particular instance of studynotes
 *
 * @author
 * @version $Id: view.php,v 1.22 2010/02/07 09:33:33 fabiangebert Exp $
 * @package studynotes
 **/
...
if (! isset ($_GET["frame"])) {
	...
	$html .= get_string('oss_outdated','studynotes');
