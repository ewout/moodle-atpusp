...
function reportssummary_usertable($cm,$wikiid, $contexts, $subwiki, $viewgroupid, $header, $rolenames, $csv) {
    ...
    $usercreates = ouwiki_get_userspagecreate($subwiki->id);
      ...
      $usersinfo = ouwiki_get_usersedits($contexts,$subwiki->id, $viewgroupid, 0);
      $usercomments = ouwiki_get_userscomments($contexts, $subwiki->id, $viewgroupid, 0);
...
<<<EOF
		<tr>
			<td class='ouw_leftcol'><a href="reportsuser.php?id=$wikiid&amp;userid=$userid">$name</a></td>
