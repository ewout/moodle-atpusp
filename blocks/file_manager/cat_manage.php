...
*/
    ...
    print_header(strip_tags(get_string("titlecats", 'block_file_manager')), "$course->fullname",
        " $courselink "."<a href=\"view.php?id=$id\">".get_string("filemanager", 'block_file_manager').
		"</a> -> ".get_string("categories", 'block_file_manager'), '', '', true, '', navmenu($course, null, 1),"","");
