...
*/
    ...
    */
	...
	/*
	$cbu = NULL;
	if (isset($_POST['cbu'])) {			/// A REMPLACER PAR L'APPEL du paramètre
	...
	*/
    ...
    print_header(strip_tags(get_string('addlink', 'block_file_manager')), "$course->fullname",
        " $courselink <a href=\"view.php?id={$id}&amp;groupid={$groupid}&amp;rootdir={$rootdir}\">".get_string("filemanager", 'block_file_manager')."</a> -> ".get_string("btnfilesharing", 'block_file_manager'), '', '', true, '',
