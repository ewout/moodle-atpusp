<?php
     ...
     * @version $Id: file.php,v 1.1.1.1 2008/07/16 10:11:38 cvswriter Exp $
     * @package moodlecore
     */
  ...
  // security: login to course if necessary
    ...
    function not_found($cid) {
        global $CFG;
        header('HTTP/1.0 404 not found');
        error(get_string('filenotfound', 'error'), $CFG->wwwroot.'/course/view.php?id='.$cid); //this is not displayed on IIS??
    }
    exit;
?>