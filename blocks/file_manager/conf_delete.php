...
//////////////// NEed to fix to get multiple folder deletion working //////////
	...
	print_header(strip_tags(get_string('confdelete', 'block_file_manager')), "$course->fullname",
        " $courselink <a href=\"view.php?id={$id}&groupid={$groupid}\">".get_string('filemanager', 'block_file_manager').'</a> -> '.
		get_string('confdelete', 'block_file_manager'), '', '', true, '', navmenu($course, null, 1), '', '');
