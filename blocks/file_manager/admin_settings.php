...
*/
	...
	print_header(strip_tags(get_string('msgadminsetinstruct', 'block_file_manager')), "$course->fullname",
                 "$courselink $stradminsettings", '', '', true, '',
                 navmenu($course, null, 1),'',''); 
    /**
    // TODO : remove above code and get it more compatible using this code :
