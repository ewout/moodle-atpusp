...
if($edit == 1) {
	...
	if ( $outer_categories ) {
		...
		foreach ($outer_categories as $curcategory ) {
			...
			echo '<a href="'.$CFG->wwwroot.'/blocks/exabis_eportfolio/view_categories.php?cataction=edit&amp;sesskey=' . sesskey() . '&amp;catconfirm=1&amp;courseid='.$courseid.'&amp;editid='.$curcategory->id.'&amp;edit=1"><img src="'.$CFG->wwwroot.'/pix/i/edit.gif" width="16" height="16" alt="'.get_string("edit").'" /></a>';
			...
			if($inner_categories) {
				foreach ($inner_categories as $innercurcategory ) {
					...
					echo '<a href="'.$CFG->wwwroot.'/blocks/exabis_eportfolio/view_categories.php?cataction=edit&amp;sesskey=' . sesskey() . '&amp;catconfirm=1&amp;courseid='.$courseid.'&amp;editid='.$innercurcategory->id.'&amp;edit=1"><img src="'.$CFG->wwwroot.'/pix/i/edit.gif" width="16" height="16" alt="'.get_string("edit").'" /></a>';
