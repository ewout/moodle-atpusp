...
if (!$views) {
	...
	*/
	...
	foreach ($views as $view) {
		...
		$table->data[$view_i]['name'] = '<a href="'.s($CFG->wwwroot.'/blocks/exabis_eportfolio/shared_view.php?courseid='.$courseid.'&access=id/'.$USER->id.'-'.$view->id).'">' . format_string($view->name) . "</a>";
		if ($view->description) {
