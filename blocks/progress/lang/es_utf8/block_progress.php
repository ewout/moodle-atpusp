...
$string['config_header_colour'] = 'Color'; 
...
$string['config_header_name'] = 'Nombre'; 
$string['config_header_status'] = 'Estado'; 
$string['config_header_type'] = 'Tipo';
$string['config_icons'] = '&iacute;conos en uso';
$string['config_now'] = 'Uso';
$string['date_format'] = '%%a %%d %%b, %%I:%%M %%p';
$string['default_colour'] = 'color por defecto';
$string['default_title'] = 'Barra de Progreso';
...
$string['setting_title'] = 'setear el t&iacute;tulo'; 
$string['status_attempted'] = 'Intento/Posteado a/Enviado/Visto'; 
$string['status_future_not_attempted'] = 'Eventos Pr&oacute;ximos'; 
$string['status_not_attempted'] = 'No intentado/Posteado a /Enviado /Visto';
$string['time_expected'] = 'Se esperaba para el'; 
$string['title'] = 'Instancia del t&iacute;tulo'; 
$string['title_monitored'] = 'Monitored Activities/Resources'; // needs translation
$string['what_actions_can_be_monitored'] = 'que acciones se pueden nomitorear'; 
$string['what_can_be_monitored'] = 'que se puede monitorear'; 
$string['what_does_monitored_mean'] = 'lo que significa un seguimiento';
$string['what_expected_by_means'] = 'lo esperado'; 
$string['what_locked_means'] = 'que medios estan cerrados por fecha l&iacute;mite'; 
$string['why_change_colours'] = '¿es posible que desee cambiar de color?'; 
$string['why_use_icons'] = 'es posible que desee utilizar los iconos?'; 
$string['why_display_now'] = 'es posible que desee ocultar / mostrar el indicador de AHORA'; 
