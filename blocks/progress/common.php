...
$modules = array(
    ...
    'scorm' => array(
        'actions'=>array(
            ...
            'completed'    => 'SELECT id FROM '.$CFG->prefix.'scorm_scoes_track WHERE scormid=\'#EVENTID#\' AND userid=\'#USERID#\' AND element=\'cmi.core.lesson_status\' AND value=\'completed\'',
            'passed'       => 'SELECT id FROM '.$CFG->prefix.'scorm_scoes_track WHERE scormid=\'#EVENTID#\' AND userid=\'#USERID#\' AND element=\'cmi.core.lesson_status\' AND value=\'passed\''
        ),
        'defaultAction' => 'attempted'
    ),
    'wiki' => array(
