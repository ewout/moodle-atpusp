...
// Funções para gerenciamento das operações AJAX do relatório de tutores
...
// Segurança
if (isloggedin()) {
	// Cria um novo objeto RepTutor e processa a função desejada
	$reptutor = new RepTutor($id, $instanceid);
